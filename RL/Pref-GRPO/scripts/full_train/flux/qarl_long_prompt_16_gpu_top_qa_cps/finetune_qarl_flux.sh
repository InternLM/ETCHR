...
export WANDB_NAME="qarl_long_prompt_16_gpu_top_qa_cps"
...
DATA_JSON_PATH="/mnt/shared-storage-user/mllm/xinglong/Pref-GRPO/grocery/qa_construction_3/4_filter_group_acc/filter/top_2400_by_qa_list.jsonl"
