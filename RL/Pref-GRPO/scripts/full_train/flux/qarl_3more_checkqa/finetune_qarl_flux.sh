...
export WANDB_NAME="qarl_3more_checkqa"
...
DATA_JSON_PATH="/mnt/shared-storage-user/mllm/xinglong/Pref-GRPO/grocery/qa_construction_2/3_1_filtert_qa/3more_qa_6205.jsonl"
