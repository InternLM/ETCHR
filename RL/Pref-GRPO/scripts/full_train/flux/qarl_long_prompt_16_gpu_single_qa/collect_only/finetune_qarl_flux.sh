...
export EXP_NAME="qarl_long_prompt_16_gpu_single_qa"
...
# 训练数据（包含 keep_qa_list）- 与主训练脚本一致（single_qa 数据集）
DATA_JSON_PATH="/mnt/shared-storage-user/mllm/xinglong/Pref-GRPO/grocery/qa_construction_3/4_filter_single_qa_std0.1_minq3_5673.jsonl"
...
TRAIN_ARGS=(
  ...
  # QARL reward 配置 - 与主训练脚本一致（多项选择题模式）
