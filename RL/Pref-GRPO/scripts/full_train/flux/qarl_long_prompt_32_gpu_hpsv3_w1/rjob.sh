rjob submit --name=qarl-flux-long-prompt-32-gpu-hpsv3-w1 \
--gpu=8 --memory=800000 \
--cpu=80 \
...
-- bash -ex /mnt/shared-storage-user/mllm/xinglong/Pref-GRPO/scripts/full_train/flux/qarl_long_prompt_32_gpu_hpsv3_w1/finetune_qarl_flux.sh