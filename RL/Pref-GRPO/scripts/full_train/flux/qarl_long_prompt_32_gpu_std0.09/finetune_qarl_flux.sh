...
export WANDB_NAME="qarl_long_prompt_32_gpu_std0.09"
...
DATA_JSON_PATH="/mnt/shared-storage-user/mllm/xinglong/Pref-GRPO/grocery/qa_construction_3/4_filter_group_acc_std0.09_3522.jsonl"
