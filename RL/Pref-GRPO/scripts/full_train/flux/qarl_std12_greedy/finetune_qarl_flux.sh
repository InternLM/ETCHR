...
export WANDB_NAME="qarl_std12_greedy"
...
DATA_JSON_PATH="/mnt/shared-storage-user/mllm/xinglong/Pref-GRPO/grocery/qa_construction_2/4_filter_group_acc/high_std_0.12.jsonl"
# Embed 文件目录（prompt_embed, pooled_prompt_embeds, text_ids）
EMBED_DIR="/mnt/shared-storage-user/mllm/xinglong/Pref-GRPO/data/unigenbench_train_prompt_rl_embeddings"
