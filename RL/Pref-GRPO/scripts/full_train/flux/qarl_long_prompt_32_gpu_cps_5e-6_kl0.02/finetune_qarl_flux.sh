...
export WANDB_NAME="qarl_long_prompt_32_gpu_cps_5e-6_kl0.02"
...
TRAIN_ARGS=(
  ...
  --flow_mode "cps"
  --kl_beta 0.02
  --kl_reference_model_name_or_path /mnt/shared-storage-user/mllm/xinglong/LLaMA-Factory-mllm-main/mllm_ckpts/FLUX.1-dev
  # QARL reward 配置
