...
export WANDB_PROJECT="Pref-GRPO-qwenimage"
export WANDB_NAME="qwenimage_qarl_long_prompt_32_gpu_cps_5e-6_kl0.02"
export WANDB_DIR="/mnt/shared-storage-user/mllm/xinglong/Pref-GRPO/wandb/wandb_2_5/${WANDB_NAME}"
wandb login
...
OUTPUT_DIR="outputs/qwen_image/${EXP_NAME}"
mkdir -p $OUTPUT_DIR
# 训练数据（包含 keep_qa_list）
DATA_JSON_PATH="/mnt/shared-storage-user/mllm/xinglong/Pref-GRPO/data/unigenbench_train_data_qwenimage/videos2caption.json"
# Embed 文件目录（prompt_embed, pooled_prompt_embeds, text_ids）
EMBED_DIR="/mnt/shared-storage-user/mllm/xinglong/Pref-GRPO/data/unigenbench_train_data_qwenimage"

TRAIN_ARGS=(
  "${COMMON_TRAIN_ARGS[@]}"
  --pretrained_model_name_or_path /mnt/shared-storage-user/mllm/xinglong/LLaMA-Factory-mllm-main/mllm_ckpts/Qwen-Image
  --vae_model_path /mnt/shared-storage-user/mllm/xinglong/LLaMA-Factory-mllm-main/mllm_ckpts/Qwen-Image
  ...
  --flow_mode "cps"
  --kl_beta 0.02
  --kl_reference_model_name_or_path /mnt/shared-storage-user/mllm/xinglong/LLaMA-Factory-mllm-main/mllm_ckpts/Qwen-Image
  # QARL reward 配置
  --reward_spec '{"qarl": 1.0, "clip": 0.0}'
  # --eplus_option
  --qarl_host "${QARL_HOST}"
